...
class SeatsControllerTest < ActionController::TestCase
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post :create, seat: { column: @seat.column, flight_id: @seat.flight_id, price: @seat.price, row: @seat.row, seat_id: @seat.seat_id, status: @seat.status }
    end
  ...
  test "should update seat" do
    patch :update, id: @seat, seat: { column: @seat.column, flight_id: @seat.flight_id, price: @seat.price, row: @seat.row, seat_id: @seat.seat_id, status: @seat.status }
    assert_redirected_to seat_path(assigns(:seat))
  end
